    ...
    return (
      <>
        {projects.map((project) => (
          <div key={project.id} className="w-full rounded-md border border-muted bg-muted shadow-lg hover:border-muted-foreground transition duration-200 ease-linear overflow-hidden">
